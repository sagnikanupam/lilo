...
analyzer = SynthesisExperimentAnalyzer(experiment_name=EXPERIMENT_NAME, experiment_types=["dreamcoder"], allow_incomplete_results=True, domains = ["logo"], compute_likelihoods=COMPUTE_LIKELIHOODS, batch_size = 96, seeds = [111, 222, 333,],)
...
bp.figure.savefig("weighted_stitch_three_random_seeds_2-26_96_cpus_logo_bar_plot.png")
...
rel.savefig('weighted_stitch_three_random_seeds_2-26_96_cpus_logo_rel_plot.png')
