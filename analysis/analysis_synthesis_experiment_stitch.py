...
analyzer = SynthesisExperimentAnalyzer(experiment_name=EXPERIMENT_NAME, experiment_types=["dreamcoder"], allow_incomplete_results=True, domains = ["re2"], compute_likelihoods=COMPUTE_LIKELIHOODS, batch_size = 96, seeds = [111],)
...
bp.figure.savefig("three_random_seeds_partial_2-14_re2_bar_plot.png")
...
rel.savefig('three_random_seeds_partial_2-14_re2_rel_plot.png')
